...
public final class JavaWordCount {
  ...
  public static void main(String[] args) {
    ...
    for (Tuple2<?,?> tuple : output) {
      System.out.println("Escrava isto >>>>>>>>> " + tuple._1() + ": " + tuple._2());
    ...
    try { 
        //spark.sql("insert into my.ds_jogador values ( 37, 'Teste', 'Botafogo', 'MID', 'nenhuma relevante') ");
      	  spark.sql("use my ");
        } catch (Exception e) { 
      	  e.printStackTrace();
      	  JOptionPane.showMessageDialog(null, "Erro do Hive\n");
        }
